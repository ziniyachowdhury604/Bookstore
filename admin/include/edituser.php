...
<div class="container">
    <form method="get" action="../backend/edit-user.php">
        <div class="row">
            <div class="col-md-6">
    ...
    <form class="mt-5" enctype="multipart/form-data"  action="../../bookstore/backend/edit-user.php" name="registrationUpdateForm" method="POST"> 
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-outline flex-fill mb-0">
                    ...
                    <input type="hidden" value="<?php if(isset($data['password'])){echo $data['password'];} ?>" name="oldpassword">
                </div>
            </div>
